...
class wpdb {
	...
	var $tables = array('user', 'usermeta');
	public $comments;
...
" ), htmlspecialchars( $this->dbhost, ENT_QUOTES ) ), 'db_connect_fail' );
	...
	public function check_database_version() {
		...
		if ( version_compare($this->db_version(), $required_mysql_version, '<') )
			return new WP_Error('database_version', sprintf( __( '<strong>ERROR</strong>: SumHax %1$s requires MySQL %2$s or higher' ), $wp_version, $required_mysql_version ));
	}
